...
<form id="rafflepress-campaign-form" method="post" enctype="multipart/form-data">
    ...
    if (get_transient('rafflepress_campaign_success')) {
        echo '<div class="mlab-campaign-success notice notice-success success-message">' . esc_html__('Your giveaway was successfully updated! You will be redirected.', 'me5rine-lab') . '</div>';
